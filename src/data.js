window.StormbringerData = {
  ...
  encyclopedia: {
    enemies: [
      ...
      { mark: "*", color: "#ff5b74", shape: "enemy", title: "Mine", text: "Aggressive space hazard that darts into a random point in the upper half of the screen, then arms after it arrives. Mines do not fire, but they create area blasts when destroyed.", tip: "Read the landing point, then decide whether to clear it for space or use its blast against nearby enemies." },
    ...
    mechanics: [
      ...
      { mark: "R", color: "#ffd166", shape: "main", title: "Main/Sub Slots", text: "Shotgun is the current main weapon powerup. Missiles and machine gun are sub weapons. One main and one sub can run together.", tip: "Picking up the same slot swaps that category." },
